...
class BuildPrune extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
    ...
    /**
     * @return null|BuildPrunePostResponse200
    ...
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ($status === 500) {
            throw new BuildPruneInternalServerErrorException($serializer->deserialize($body, 'Docker\API\Model\ErrorResponse', 'json'), $response);
        }
    }
}
