...
class NetworkPrune extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
    ...
    /**
     * @return null|NetworksPrunePostResponse200
    ...
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ($status === 500) {
            throw new NetworkPruneInternalServerErrorException($serializer->deserialize($body, 'Docker\API\Model\ErrorResponse', 'json'), $response);
        }
    }
}
