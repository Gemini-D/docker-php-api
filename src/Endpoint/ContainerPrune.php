...
class ContainerPrune extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
    ...
    /**
     * @return null|ContainersPrunePostResponse200
    ...
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ($status === 500) {
            throw new ContainerPruneInternalServerErrorException($serializer->deserialize($body, 'Docker\API\Model\ErrorResponse', 'json'), $response);
        }
    }
}
