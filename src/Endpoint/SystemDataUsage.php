...
class SystemDataUsage extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
    ...
    /**
     * @return null|SystemDfGetResponse200
    ...
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ($status === 500) {
            throw new SystemDataUsageInternalServerErrorException($serializer->deserialize($body, 'Docker\API\Model\ErrorResponse', 'json'), $response);
        }
    }
}
