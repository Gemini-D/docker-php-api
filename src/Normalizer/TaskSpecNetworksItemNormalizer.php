...
use ArrayObject;
use Docker\API\Model\TaskSpecNetworksItem;
...
if (! class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskSpecNetworksItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return is_object($data) && get_class($data) === 'Docker\API\Model\TaskSpecNetworksItem';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new TaskSpecNetworksItem();
        ...
        {
            return ['Docker\API\Model\TaskSpecNetworksItem' => false];
        }
    }
} else {
    class TaskSpecNetworksItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
